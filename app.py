...
def main():
    ...
    show_auto_questions = st.sidebar.checkbox('Show Autogenerated Questions')
    ...
    <div style="display: flex; align-items: center; margin-left: 0;">
        <h1 style="display: inline-block;">Chat With PDF</h1>
    </div>
    """,
    unsafe_allow_html=True,
        )
    ...
    if uploaded_files:
       ...
       # Display the question-answer pairs in the sidebar with smaller text
        ...
        if show_auto_questions:
            st.sidebar.subheader("Autogenerated Questions")
